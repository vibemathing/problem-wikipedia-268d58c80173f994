...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-268d58c80173f994"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-268d58c80173f994",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-268d58c80173f994",
        "url": "https://en.wikipedia.org/wiki/Bombieri%E2%80%93Lang_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Bombieri–Lang conjecture : $K$ -rational points on a variety of general type over a number field $K$ are not a dense set in Zariski topology.",
      "version": 1
    },
    "title": "Bombieri–Lang conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "ca82a23080d499be037df169fcfe9fed37f2c28f2f49e5798a55fc5127a754de"
}
```
